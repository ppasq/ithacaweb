...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ProjectIngredient',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
            ],
            options={
                'verbose_name_plural': 'Project ingredients',
            },
        ),
        migrations.CreateModel(
            name='ProjectPage',
        ...
        migrations.AddField(
            ...
            name='project_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='projects.ProjectType'),
        ),
        migrations.AddField(
            model_name='projectpage',
            name='image',
        ...
        migrations.AddField(
            model_name='projectpage',
            name='ingredients',
            field=modelcluster.fields.ParentalManyToManyField(blank=True, to='projects.ProjectIngredient'),
        ),
        migrations.AddField(
            model_name='projectpage',
            name='origin',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='projects.Country'),
        ),
    ]
