...
ROOT_URLCONF = 'ithacaweb.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['ithacaweb/templates', ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ithacaweb.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'ithacawebdb')
    }
}
...
# Wagtail settings
WAGTAIL_SITE_NAME = "ithacaweb"


# Custom ITHACA settings
